		...
		{	
			public void actionPerformed(ActionEvent calculateButton)
			{
						...
						&& yardsTextField.getText().equals(DEFAULT_TEXTFIELD_VALUE))
				{
					...
					inchesTextField.setText(doubleFormat.format(tempValue * .394) + "");			//Converts cm to inches
					yardsTextField.setText(doubleFormat.format((tempValue * .394 )* .0278) + "");	//Converts cm to yd
				}
						...
						&& yardsTextField.getText().equals(DEFAULT_TEXTFIELD_VALUE))
				{
					...
					centimetersTextField.setText(doubleFormat.format(tempValue * 100) + "");		//Converts cm to m
					inchesTextField.setText(doubleFormat.format(tempValue * 39.37) + "");			//Converts cm to inches
					yardsTextField.setText(doubleFormat.format(tempValue* 1.094) + "");				//Converts cm to yd
				}
						...
						&& yardsTextField.getText().equals(DEFAULT_TEXTFIELD_VALUE))
				{
					...
					centimetersTextField.setText(doubleFormat.format(tempValue * 2.54) + "");		//Converts cm to m
					metersTextField.setText(doubleFormat.format(tempValue * 0.0254) + "");			//Converts cm to inches
					yardsTextField.setText(doubleFormat.format( tempValue * 0.0278) + "");			//Converts cm to yd
				}
						...
						&& inchesTextField.getText().equals(DEFAULT_TEXTFIELD_VALUE))
				{
					...
					centimetersTextField.setText(doubleFormat.format(tempValue * 91.44) + "");		//Converts cm to m
					metersTextField.setText(doubleFormat.format(tempValue * 0.914) + "");			//Converts cm to inches
					inchesTextField.setText(doubleFormat.format(tempValue * 36.00) + "");			//Converts cm to yd
				}
